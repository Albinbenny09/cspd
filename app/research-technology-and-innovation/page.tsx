...
export default function ResearchTechnologyInnovationPage() {
  return (
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 text-white/75 text-lg leading-relaxed">
                Analyses on the development, diffusion, and impact of technology on productivity
                and societal change in a rapidly evolving world.
              </p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#3D111F]/60 p-2">
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-2xl bg-black/30">
                <Image
                  src="https://cspdin.wordpress.com/wp-content/uploads/2026/01/dsc07675-01.jpeg"
                  alt="Science, Technology and Innovation"
                  fill

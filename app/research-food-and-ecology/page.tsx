...
export default function ResearchFoodEcologyPage() {
  return (
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h1 className="mt-6 text-4xl md:text-5xl font-bold font-serif leading-tight">
                Food, Ecology, and Climate Change
              </h1>

              <p className="mt-6 text-white/75 text-lg leading-relaxed">
                Intersections of food systems, ecology, and climate change, focusing on
                sustainability, livelihoods and environmental justice.
              </p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#3D111F]/60 p-2">
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-2xl bg-black/30">
                <Image
                  src="https://cspdin.wordpress.com/wp-content/uploads/2026/01/dsc04204.jpg"
                  alt="Food, Ecology, and Climate Change"
                  fill

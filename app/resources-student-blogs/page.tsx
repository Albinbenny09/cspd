...
export default function ResourcesStudentBlogsPage() {
  return (
          ...
          <div className="mx-auto max-w-5xl rounded-3xl border border-white/10 bg-white/[0.03] p-8 md:p-10">
            <div className="grid gap-8 md:grid-cols-2 md:items-center">
              <div>
                ...
                <h1 className="mt-5 text-4xl md:text-5xl font-bold font-serif">Student Blogs</h1>
                <p className="mt-4 text-white/75">PComing soon.</p>
              </div>

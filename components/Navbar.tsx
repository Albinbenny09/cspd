  ...
  const navLinks = [
    ...
    { 
      ...
      dropdown: [
        ...
        { name: "Affiliate Members", href: "/affiliate-members/" },
    ...
    { 
      ...
      href: "#initiatives",
      dropdown: [
        { name: "Seminars & Centre Talk Series", href: "/initiatives-lecture-series/" },
        { name: "HOPES Conference 2026", href: "/hopes-conference/" },
        { name: "Summer School", href: "/summer-school/" },
        { name: "Trainings & Workshops", href: "/trainings-workshops/" },    
        { name: "Faculty & Student Exchanges", href: "/faculty-student-exchanges/" },
      ]
    },
    { 
      name: "Connect", 
    ...
    { 
      ...
      dropdown: [
        ...
        { name: "Centre Data Repository (CDR)", href: "/centre-data-repository/" },
      ]
    },
    { 
      name: "Careers", 
